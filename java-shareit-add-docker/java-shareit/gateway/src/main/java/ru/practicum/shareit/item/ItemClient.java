...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveItem(long userId, ItemDtoGate itemDto) {
        return post("", userId, itemDto);
    }

    public ResponseEntity<Object> updateItem(long userId, ItemDtoGate itemDto, Long itemId) {
    ...
    public ResponseEntity<Object> addComment(long userId, CommentDtoGate commentDtoIn, Long itemId) {
